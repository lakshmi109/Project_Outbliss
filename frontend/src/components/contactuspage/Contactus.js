  ...
  return (
    <>
        <div className='contactuscontainer'>
            <h1> Contact Us </h1>
            <p>Any questions or remarks just send us a message</p>
            ...
            <div className='contactusformcontainer'>
                <div className='contactusinfo'>
                    ...
                    <p>For futher query connect with us on given contacts</p>
                    ...
                    <div className='contactusinfosocial'>
                        <a href="/" className='conctactusinfosocialicon'>
                ...
                <div className='contactusformbox'>
                    <div class="input-container">
                        <input placeholder="" class="input-field" type="text"/>
                    ...
                    <div class="input-container">
                        <input placeholder="" class="input-field" type="text"/>
                        <label for="input-field" class="input-label">Write a message</label>
                        <span class="input-highlight"></span>
                    </div>
